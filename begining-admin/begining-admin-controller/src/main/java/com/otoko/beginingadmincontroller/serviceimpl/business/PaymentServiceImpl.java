...
import com.otoko.beginingadmincontroller.serviceimpl.shiro.UserServiceImpl;
import com.otoko.beginingadminentity.entity.admin.shiro.User;
import com.otoko.beginingadminservice.service.admin.business.PaymentService;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    @Value("${begining.payment.token}")
    private String token;

    @Value("${begining.payment.codePayId}")
    private String codePayId;

    @Value("${begining.payment.notifyUrl}")
    private String notifyUrl;

    @Value("${begining.payment.returnUrl}")
    private String returnUrl;

    @Value("${begining.payment.key}")
    private String key;
