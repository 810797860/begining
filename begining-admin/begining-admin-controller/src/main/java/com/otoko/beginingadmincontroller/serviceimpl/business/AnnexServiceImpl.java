...
import com.otoko.beginingadminentity.entity.admin.business.Annex;
import com.otoko.beginingadminmapper.mapper.admin.business.AnnexMapper;
import com.otoko.beginingadminservice.service.admin.business.AnnexService;
...
public class AnnexServiceImpl extends BaseServiceImpl<AnnexMapper, Annex> implements AnnexService {
    ...
    @Value("${begining.file.uploadPath}")
