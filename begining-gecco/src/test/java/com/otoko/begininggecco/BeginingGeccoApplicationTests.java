...
@SpringBootTest
public class BeginingGeccoApplicationTests {
	...
	public static void insertElectricAppliance(com.otoko.begininggecco.electricAppliance.DangDetail dangDetail){
		try {
			...
			if (dangDetail.getCover() != null) {
				...
				jdbcTemplate.update("INSERT INTO c_business_annex(name, type, extension, size, path, md5, content_type, uuid, description, deleted) VALUES('" +
						...
						"jpg" + "','" +
						0 + "','" +
						"G:/data/file/begining/2019-03-24/" + name + ".jpg" + "','" +
						"" + "','" +
						"image/jpeg" + "','" +
						ToolUtil.getUUID() + "','" +
						"" + "','" +
	...
	public static void insertBookLibrary(com.otoko.begininggecco.bookLibrary.DangDetail dangDetail){
		try {
			if (jdbcTemplate == null){
				init();
			}
			...
			if (dangDetail.getCover() != null) {
				...
				jdbcTemplate.update("INSERT INTO c_business_annex(name, type, extension, size, path, md5, content_type, uuid, description, deleted) VALUES('" +
						...
						"jpg" + "','" +
						0 + "','" +
						"G:/data/file/begining/2019-03-26/" + name + ".jpg" + "','" +
						"" + "','" +
						"image/jpeg" + "','" +
						ToolUtil.getUUID() + "','" +
						"" + "','" +
	...
	public static void insertSportsSpecial(com.otoko.begininggecco.sportsSpecial.DangDetail dangDetail){
		try {
			if (jdbcTemplate == null){
				init();
			}
	...
	public static void insertDigitalSquare(com.otoko.begininggecco.digitalSquare.DangDetail dangDetail){
		try {
			if (jdbcTemplate == null){
				init();
			}
			...
			if (dangDetail.getCover() != null) {
				...
				jdbcTemplate.update("INSERT INTO c_business_annex(name, type, extension, size, path, md5, content_type, uuid, description, deleted) VALUES('" +
						...
						"jpg" + "','" +
						0 + "','" +
						"G:/data/file/begining/2019-03-27/" + name + ".jpg" + "','" +
						"" + "','" +
						"image/jpeg" + "','" +
						ToolUtil.getUUID() + "','" +
						"" + "','" +
