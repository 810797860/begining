...
import com.otoko.begininggecco.downloader.DownloaderAOPFactory;
import com.otoko.begininggecco.downloader.DownloaderFactory;
import com.otoko.begininggecco.downloader.MonitorDownloaderFactory;
import com.otoko.begininggecco.dynamic.GeccoClassLoader;
import com.otoko.begininggecco.dynamic.GeccoJavaReflectionAdapter;
import com.otoko.begininggecco.pipeline.DefaultPipelineFactory;
import com.otoko.begininggecco.pipeline.Pipeline;
import com.otoko.begininggecco.pipeline.PipelineFactory;
import com.otoko.begininggecco.request.HttpRequest;
import com.otoko.begininggecco.spider.render.MonitorRenderFactory;
import com.otoko.begininggecco.spider.render.RenderFactory;
import com.otoko.begininggecco.spider.render.RenderType;
import com.otoko.begininggecco.utils.ReflectUtils;
import com.otoko.begininggecco.utils.UrlMatcher;
	...
	public SpiderBeanFactory(String classPath, PipelineFactory pipelineFactory) {
		if (StringUtils.isNotEmpty(classPath)) {
			reflections = new Reflections(
					ConfigurationBuilder.build("com.otoko.begininggecco", classPath, GeccoClassLoader.get())
							.setMetadataAdapter(new GeccoJavaReflectionAdapter())
							.setExpandSuperTypes(false));
			// reflections = new Reflections("com.otoko.begininggecco", classPath);
		} else {
			reflections = new Reflections(ConfigurationBuilder.build("com.otoko.begininggecco", GeccoClassLoader.get())
					.setMetadataAdapter(new GeccoJavaReflectionAdapter())
					.setExpandSuperTypes(false));
			// reflections = new Reflections("com.otoko.begininggecco");
		}
		dynamic();
