...
public abstract class DownloaderFactory {
	...
	public DownloaderFactory(Reflections reflections) {
		...
		Set<Class<?>> classes = reflections.getTypesAnnotatedWith(com.otoko.begininggecco.annotation.Downloader.class);
		for(Class<?> downloaderClass : classes) {
			com.otoko.begininggecco.annotation.Downloader downloader = (com.otoko.begininggecco.annotation.Downloader)downloaderClass.getAnnotation(com.otoko.begininggecco.annotation.Downloader.class);
			try {
